...
public class NativeDrawVideoActivity extends Activity {
    ...
    private int[] imgs = {R.mipmap.taku_testvideo1_thumb, R.mipmap.taku_testvideo2_thumb, R.mipmap.taku_testvideo2_thumb};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.taku_activity_native_draw_video);
