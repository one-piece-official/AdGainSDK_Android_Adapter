...
public class NativeListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private AdViewHolder onCreateAdViewHolder( ViewGroup viewGroup) {
        ...
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.taku_native_list_ad_item, viewGroup, false);
        return new AdViewHolder(view);
    }

    private DataViewHolder onCreateDataViewHolder( ViewGroup viewGroup) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.taku_native_list_data_item, viewGroup, false);
        return new DataViewHolder(view);
    }

    private MoreViewHolder onCreateMoreViewHolder( ViewGroup viewGroup) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.taku_native_list_more_item, viewGroup, false);
