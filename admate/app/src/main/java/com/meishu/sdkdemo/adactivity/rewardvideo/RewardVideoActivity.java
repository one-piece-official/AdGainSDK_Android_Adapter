...
public class RewardVideoActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private RewardVideoEventLoader rewardVideoLoader;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MsAdSlot qzxAdSlot = new MsAdSlot.Builder()
                .setPid(posId)
                .setVideoMute(false)
                .build();
        rewardVideoLoader = new RewardVideoEventLoader(this, qzxAdSlot, adEventListener);
    }
        ...
        switch (v.getId()) {
            ...
            case R.id.load_video:
                ...
                if (null == rewardVideoLoader) {
                    rewardVideoLoader   = new RewardVideoEventLoader(this, adSlot, adEventListener);
...
//                rewardVideoLoader.loadAd();
    ...
    RewardAdLoadListener adEventListener = new RewardAdLoadListener() {
        @Override
        ...
        @Override
        public void onAdFail(RewardVideoAd rewardVideoAd, AdError adError, int i) {
            Log.d(TAG, "DEMO ADEVENT " + (new Throwable().getStackTrace()[0].getMethodName()));
