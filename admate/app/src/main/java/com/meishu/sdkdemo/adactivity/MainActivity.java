...
public class MainActivity extends DemoBaseActivity implements View.OnClickListener {
    ...
    private void initSdk() {
        ...
        CheckBox cbShowFloatView = findViewById(R.id.allowShowFloatView);
        ...
        cbShowFloatView.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                FloatView.setAllowShowFloatView(isChecked);
            }
        });
    }
