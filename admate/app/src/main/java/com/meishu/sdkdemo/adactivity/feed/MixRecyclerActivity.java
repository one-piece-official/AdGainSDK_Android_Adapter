...
import com.meishu.sdk.core.ad.recycler.FeedInteractionListener;
import com.meishu.sdk.core.ad.recycler.NativeAdMediaListener;
...
import com.meishu.sdkdemo.utils.bquery.BQuery;
...
public class MixRecyclerActivity extends AppCompatActivity  {
    ...
    private RecyclerMixAdEventLoader recyclerAdLoader;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mix_recycler);
        initView();
        ...
        MsAdSlot adSlot = new MsAdSlot.Builder()
                ...
                .build();
        recyclerAdLoader = new RecyclerMixAdEventLoader(this, adSlot, new RecyclerAdLoadListener() {
        ...
        public int getItemViewType(int position) {
            try {
                if (mADSet.contains(position)){
                    RecyclerAdData ad = (RecyclerAdData) mData.get(position);
...
//                    holder.container.removeAllViews();
            ...
            ad.bindAdToView(holder.container.getContext(), holder.container,
                    clickableViews, new FeedInteractionListener() {
                        @Override
                        public void onAdClosed() {
                            // 自渲染模式下，媒体主动移除广告时，收不到onAdClosed回调
                            LogUtil.d(TAG, "DEMO ADEVENT " + (new Throwable().getStackTrace()[0].getMethodName()));
                        }
...
//            }
        ...
        private void setAdListener(final CustomHolder holder, final RecyclerAdData ad) {
            // 视频广告
            if (ad.getAdPatternType() == MsAdPatternType.VIDEO) {
                ad.setNativeMediaListener(new NativeAdMediaListener() {
                    @Override
                ...
                // TODO: 2025/6/12 这里直接add?
                holder.mediaView.removeAllViews();
                holder.mediaView.addView(ad.getMediaView());
...
//                    clickableViews, new FeedExpressAdInteractionListener() {
//                        @Override
//                        public void onAdClosed() {
//                            LogUtil.d(TAG, "DEMO ADEVENT " + (new Throwable().getStackTrace()[0].getMethodName()));
//                        }
...
//                        }
//                    });
            ad.setExpressMediaListener(new ExpressMediaListener() {
                @Override
            ...
            ad.setExpressAdInteractionListener(new FeedExpressAdInteractionListener() {
                @Override
                public void onAdClicked() {
                    Log.d(TAG, "DEMO ADEVENT " + (new Throwable().getStackTrace()[0].getMethodName()));
                }
                ...
                public void onRenderSuccess() {
                    ...
                    holder.container.removeAllViews();
                    holder.container.addView(ad.getExpressView());
                }
            });
            ad.render(MixRecyclerActivity.this);
        }
    ...
    private void showTop(BQuery logoAQ) {
    ...
    private void showBottom(BQuery logoAQ) {
