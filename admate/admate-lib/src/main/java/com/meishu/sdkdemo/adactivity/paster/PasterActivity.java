...
public class PasterActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.admate_activity_paster);
        ...
        findViewById(R.id.loadPasterAd).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MsAdSlot msAdSlot = new MsAdSlot.Builder()
                        ...
                        .build();
                pasterAdLoader = new PasterAdLoader(PasterActivity.this, videoContainer, msAdSlot, adEventListener);
                pasterAdLoader.loadAd();
            }
        });
    }

    PasterAdEventListener adEventListener = new PasterAdEventListener() {
        @Override
