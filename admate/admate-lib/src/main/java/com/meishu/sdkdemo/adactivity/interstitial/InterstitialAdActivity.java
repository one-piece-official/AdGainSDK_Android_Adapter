...
public class InterstitialAdActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.admate_activity_interstitial_ad);
    ...
    public void onClick(View v) {
        ...
        } else if (id == R.id.showInterstitailAD1) {
            interstitialAd1.showAd(this);
        } else if (id == R.id.showInterstitailAD2) {
            interstitialAd2.showAd(this);
        } else if (id == R.id.openNewActivity) {
