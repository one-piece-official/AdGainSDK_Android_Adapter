...
public class AMPSUnifiedActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.beizi_unified_activity_layout);
    ...
    private View inflateImageText(AMPSUnifiedNativeItem unifiedItem) {
        View itemView = LayoutInflater.from(this).inflate(R.layout.beizi_native_unified_item_image_text
                , null);
    ...
    private View inflateGroupImage(AMPSUnifiedNativeItem unifiedItem) {
        View itemView =
                LayoutInflater.from(this).inflate(R.layout.beizi_native_unified_item_group_image, null);
    ...
    private View inflateVideoView(AMPSUnifiedNativeItem unifiedItem) {
        View itemView = LayoutInflater.from(this).inflate(R.layout.beizi_native_unified_item_video, null);
