...
public class MediationFeedActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gromore_mediation_activity_feed);
        context = this;
        // 聚合广告位（在GroMore平台的广告位，注意不是adn的代码位）
        String nativeMode = getIntent().getStringExtra("nativeMode");
        if ("self".equals(nativeMode)) {
...
//        mMediaId = getResources().getString(R.string.feed_native_express_media_id);
        ...
        expressRadio.setText("模板ID: " + getResources().getString(R.string.feed_native_express_media_id));
        ...
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if (checkedId == R.id.expressId) {
                    mMediaId = getResources().getString(R.string.feed_native_express_media_id);
                } else if (checkedId == R.id.nativeId) {
                    mMediaId = getResources().getString(R.string.feed_native_media_id);
                }
            }
        });
