...
public class DrawNativeVideoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gromore_activity_draw_native_video);
...
//                    ad.setPauseIcon(BitmapFactory.decodeResource(mContext.getResources(), R.drawable.gromore_dislike_icon), 60);
                    int random = (int) (Math.random() * 100);
                    int index = random % videos.length;
...
//                    mediaPlayer[0] = mp;
    ...
    class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.gromore_item_view_pager, parent, false);
...
//            changeUIVisibility(holder,);
    ...
    private void initAdViewAndAction(TTDrawFeedAd ad, FrameLayout container) {
        View actionView = this.getLayoutInflater().inflate(R.layout.gromore_native_draw_action_item, null, false);
