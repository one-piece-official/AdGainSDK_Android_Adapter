...
public class NativeExpressListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gromore_activity_native_express_listview);
        //step1:初始化sdk
    ...
    private static class MyAdapter extends BaseAdapter {
        ...
        private View getVideoView(View convertView, ViewGroup parent, final TTNativeExpressAd ad) {
            final AdViewHolder adViewHolder;
            try {
                if (convertView == null) {
                    convertView = LayoutInflater.from(mContext).inflate(R.layout.gromore_listitem_ad_native_express, parent, false);
