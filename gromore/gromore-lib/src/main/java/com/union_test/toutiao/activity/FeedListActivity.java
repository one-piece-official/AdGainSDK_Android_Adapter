...
public class FeedListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gromore_activity_feed_listview);
        //step1:初始化sdk
    ...
    private static class MyAdapter extends BaseAdapter {
        ...
        private View getVerticalAdView(View convertView, ViewGroup parent, final TTFeedAd ad) {
            VerticalAdViewHolder adViewHolder;
            if (convertView == null) {
                convertView = LayoutInflater.from(mContext).inflate(R.layout.gromore_listitem_ad_vertical_pic, parent, false);
        ...
        private View getLiveVideoView(View convertView, ViewGroup parent, final TTFeedAd ad) {
            final LiveVideoViewHolder adViewHolder;
            try {
                if (convertView == null) {
                    convertView = LayoutInflater.from(mContext).inflate(R.layout.gromore_listitem_ad_vertical_live, parent, false);
        ...
        private View getVideoView(View convertView, ViewGroup parent, final TTFeedAd ad) {
            final VideoAdViewHolder adViewHolder;
            try {
                if (convertView == null) {
                    convertView = LayoutInflater.from(mContext).inflate(R.layout.gromore_listitem_ad_large_video, parent, false);
        ...
        private View getLargeAdView(View convertView, ViewGroup parent, final TTFeedAd ad) {
            final LargeAdViewHolder adViewHolder;
            if (convertView == null) {
                convertView = LayoutInflater.from(mContext).inflate(R.layout.gromore_listitem_ad_large_pic, parent, false);
        ...
        private View getGroupAdView(View convertView, ViewGroup parent, final TTFeedAd ad) {
            GroupAdViewHolder adViewHolder;
            if (convertView == null) {
                convertView = LayoutInflater.from(mContext).inflate(R.layout.gromore_listitem_ad_group_pic, parent, false);
        ...
        private View getSmallAdView(View convertView, ViewGroup parent, final TTFeedAd ad) {
            SmallAdViewHolder adViewHolder;
            if (convertView == null) {
                convertView = LayoutInflater.from(mContext).inflate(R.layout.gromore_listitem_ad_small_pic, parent, false);
        ...
        private View getNormalView(View convertView, ViewGroup parent, int position) {
            ...
            if (convertView == null) {
                ...
                convertView = LayoutInflater.from(mContext).inflate(R.layout.gromore_listitem_normal, parent, false);
...
//            creativeViewList.add(convertView);
            ...
            adViewHolder.mTitle.setText(ad.getTitle()); //gromore_title为广告的简单信息提示
