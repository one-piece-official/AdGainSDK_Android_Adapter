...
public class FeedRecyclerActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gromore_activity_feed_recycler);
        ...
        public RecyclerView.ViewHolder onCreateViewHolder( ViewGroup parent, int viewType) {
            ...
            switch (viewType) {
                ...
                case ITEM_VIEW_TYPE_SMALL_PIC_AD:
                    return new SmallAdViewHolder(LayoutInflater.from(mContext).inflate(R.layout.gromore_listitem_ad_small_pic, parent, false));
                case ITEM_VIEW_TYPE_LARGE_PIC_AD:
                    return new LargeAdViewHolder(LayoutInflater.from(mContext).inflate(R.layout.gromore_listitem_ad_large_pic, parent, false));
                case ITEM_VIEW_TYPE_VERTICAL_PIC_AD:
                    return new VerticalAdViewHolder(LayoutInflater.from(mContext).inflate(R.layout.gromore_listitem_ad_vertical_pic, parent, false));
                case ITEM_VIEW_TYPE_GROUP_PIC_AD:
                    return new GroupAdViewHolder(LayoutInflater.from(mContext).inflate(R.layout.gromore_listitem_ad_group_pic, parent, false));
                case ITEM_VIEW_TYPE_VIDEO:
                    return new VideoAdViewHolder(LayoutInflater.from(mContext).inflate(R.layout.gromore_listitem_ad_large_video, parent, false));
                default:
                    return new NormalViewHolder(LayoutInflater.from(mContext).inflate(R.layout.gromore_listitem_normal, parent, false));
            }
        }
