...
public class MediationFeedRecyclerViewAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        switch (viewType) {
            ...
            case ITEM_VIEW_TYPE_SMALL_PIC_AD:
                return new SmallAdViewHolder(LayoutInflater.from(mActivity).inflate(R.layout.gromore_mediation_listitem_ad_small_pic, parent, false));
            case ITEM_VIEW_TYPE_LARGE_PIC_AD:
                return new LargeAdViewHolder(LayoutInflater.from(mActivity).inflate(R.layout.gromore_mediation_listitem_ad_large_pic, parent, false));
            case ITEM_VIEW_TYPE_GROUP_PIC_AD:
                return new GroupAdViewHolder(LayoutInflater.from(mActivity).inflate(R.layout.gromore_mediation_listitem_ad_group_pic, parent, false));
            case ITEM_VIEW_TYPE_VIDEO:
            case ITEM_VIEW_TYPE_VIDEO_VERTICAL:
                return new VideoAdViewHolder(LayoutInflater.from(mActivity).inflate(R.layout.gromore_mediation_listitem_ad_large_video, parent, false));
            case ITEM_VIEW_TYPE_VERTICAL_IMG:
                return new VerticalAdViewHolder(LayoutInflater.from(mActivity).inflate(R.layout.gromore_mediation_listitem_ad_vertical_pic, parent, false));
            case ITEM_VIEW_TYPE_EXPRESS_AD:
                return new ExpressAdViewHolder(LayoutInflater.from(mActivity).inflate(R.layout.gromore_listitem_ad_express, parent, false));
            default:
                return new NormalViewHolder(LayoutInflater.from(mActivity).inflate(R.layout.gromore_listitem_normal, parent, false));
        }
    }
    ...
    private static class ExpressAdViewHolder extends RecyclerView.ViewHolder {
        ...
        public ExpressAdViewHolder(View itemView) {
            ...
            expressViewContainer = (FrameLayout) itemView.findViewById(R.id.gromore_listitem_ad_express);
        }
    }
