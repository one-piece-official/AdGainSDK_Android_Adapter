package com.jiguangssp.addemo.widget;
...
import com.jiguangssp.addemo.util.StringUtil;

import com.jiguangssp.addemo.R;
import com.jiguangssp.addemo.activity.NormalWebActivity;
...
public class PrivacyPolicyDialog extends Dialog {
    ...
    public PrivacyPolicyDialog(@NonNull Activity activity) {
        super(activity);
        setContentView(R.layout.jiguang_dialog_privacy_policy);
