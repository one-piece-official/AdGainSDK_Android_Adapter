...
public class InterstitialAdActivity extends BaseAdActivity implements View.OnClickListener {
    ...
    protected void onCreate( Bundle savedInstanceState) {
        ...
        setContentView(R.layout.jiguang_activity_interstitial_ad);
    ...
    public void onClick(View v) {
        ...
        } else if (id == R.id.btnLoadAndShowAd) {
            loadAndShow = true;
            loadAd();
        }
    }
    ...
    private void showAdTypeCheckDialog() {
        new AlertDialog.Builder(this)
                .setItems(R.array.jiguang_interstitial_ad_list, new DialogInterface.OnClickListener() {
                    @Override
