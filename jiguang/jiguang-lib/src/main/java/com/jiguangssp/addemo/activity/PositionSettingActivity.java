...
public class PositionSettingActivity extends BaseAdActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.jiguang_activity_position_setting);
        initPlatformData();
        initView();
        initListener();
        initData();
    ...
    private void showAdCountSelectDialog() {
        new AlertDialog.Builder(this)
                .setItems(R.array.jiguang_ad_count, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        etCount.setText(getResources().getStringArray(R.array.jiguang_ad_count)[which]);
                    }
                })
                .create()
                .show();
    ...
    private void showPlatformSelectDialog() {
        new AlertDialog.Builder(this)
                .setItems(R.array.jiguang_platforms_zh, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        etOnlySupportPlatform.setText(getResources().getStringArray(R.array.jiguang_platforms_zh)[which]);
                    }
                })
                .create()
                .show();
