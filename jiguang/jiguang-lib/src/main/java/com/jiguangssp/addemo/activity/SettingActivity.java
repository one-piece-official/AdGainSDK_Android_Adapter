...
import com.jiguangssp.addemo.adapter.SettingAdapter;
...
public class SettingActivity extends BaseAdActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.jiguang_activity_setting);
        initView();
        initData();
    }
    ...
    private void initData() {
        ...
        String[] adTypeItems = getResources().getStringArray(R.array.jiguang_ad_type_items);
