...
public class SplashAdActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.jiguang_activity_splash_ad);
        flContainer = findViewById(R.id.flContainer);
        finishOnDismiss = "true".equals(getIntent().getStringExtra("finishOnDismiss"));
        skipPrivacy = "true".equals(getIntent().getStringExtra("skipPrivacy"));
