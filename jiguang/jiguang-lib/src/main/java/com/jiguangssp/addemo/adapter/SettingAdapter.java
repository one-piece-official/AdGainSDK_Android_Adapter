...
public class SettingAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private static class TitleViewHolder extends RecyclerView.ViewHolder {
        ...
        TitleViewHolder(ViewGroup viewGroup) {
            super(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.jiguang_item_setting_title, viewGroup, false));
    ...
    private static class AdViewHolder extends RecyclerView.ViewHolder {
        ...
        AdViewHolder(ViewGroup viewGroup) {
            super(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.jiguang_item_setting_ad, viewGroup, false));
    ...
    private static class PlatformViewHolder extends RecyclerView.ViewHolder {
        ...
        private void showPlatformSelectDialog(Context context) {
            new AlertDialog.Builder(context)
                    .setItems(R.array.jiguang_platforms_zh, new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            String platformKey = context.getResources().getStringArray(R.array.jiguang_platforms_zh)[which];
