        ...
        if (developView == null) {
            switch (adPatternType) {
                case WMNativeAdDataType.NATIVE_SMALL_IMAGE_AD:
                    developView = LayoutInflater.from(context).inflate(R.layout.tobid_native_ad_item_small, null);
                    break;
                default:
                    developView = LayoutInflater.from(context).inflate(R.layout.tobid_native_ad_item_normal, null);
                    break;
            }
