...
public class InterstitialActivity extends Activity implements WMInterstitialAdListener, AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tobid_activity_interstitial);

        spinner = findViewById(R.id.id_spinner);
        arrayAdapter = new ArrayAdapter(this, android.R.layout.simple_spinner_item, getResources().getStringArray(R.array.tobid_interstitial_adapter));
    ...
    private void updatePlacementId() {
        String[] stringArray = getResources().getStringArray(R.array.tobid_interstitial_id_value);
