...
public class BannerActivity extends Activity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tobid_activity_banner);
        adContainer = findViewById(R.id.banner_ad_container);
        spinner = findViewById(R.id.id_spinner);
        arrayAdapter = new ArrayAdapter(this, android.R.layout.simple_spinner_item, getResources().getStringArray(R.array.tobid_banner_adapter));
        ...
        String[] stringArray = getResources().getStringArray(R.array.tobid_banner_id_value);
