...
public class RewardVideoActivity extends Activity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tobid_activity_reward_video);

        spinner = findViewById(R.id.id_spinner);
        arrayAdapter = new ArrayAdapter(this, android.R.layout.simple_spinner_item, getResources().getStringArray(R.array.tobid_reward_adapter));
        ...
        String[] stringArray = getResources().getStringArray(R.array.tobid_reward_id_value);
