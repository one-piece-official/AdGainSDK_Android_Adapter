...
public class NativeAdUnifiedRecycleActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tobid_activity_native_ad_unified_recycle);
        getExtraInfo();
        initListView();
    ...
    private void getExtraInfo() {
        ...
        if (TextUtils.isEmpty(placementId)) {
            String[] stringArray = getResources().getStringArray(R.array.tobid_native_id_value);
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            switch (viewType) {
                ...
                case ITEM_VIEW_TYPE_UNIFIED_AD:
                    return new UnifiedAdViewHolder(LayoutInflater.from(mActivity).inflate(R.layout.tobid_listitem_ad_native, parent, false));
                case ITEM_VIEW_TYPE_EXPRESS_AD:
                    return new ExpressAdViewHolder(LayoutInflater.from(mActivity).inflate(R.layout.tobid_listitem_ad_native, parent, false));
                default:
                    return new NormalViewHolder(LayoutInflater.from(mActivity).inflate(R.layout.tobid_listitem_normal, parent, false));
            }
        }
