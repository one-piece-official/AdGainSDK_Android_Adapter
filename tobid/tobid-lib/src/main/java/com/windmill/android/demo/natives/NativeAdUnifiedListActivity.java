...
public class NativeAdUnifiedListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tobid_activity_native_ad_unified_list);
        getExtraInfo();
        initListView();
    ...
    private static class MyAdapter extends BaseAdapter {
        ...
        private View getUnifiedADView(View convertView, ViewGroup viewGroup, @NonNull final WMNativeAdData ad) {
            ...
            try {
                if (convertView == null) {
                    convertView = LayoutInflater.from(mActivity).inflate(R.layout.tobid_listitem_ad_native, viewGroup, false);
        ...
        private View getNormalView(View convertView, ViewGroup parent, int position) {
            ...
            if (convertView == null) {
                ...
                convertView = LayoutInflater.from(mActivity).inflate(R.layout.tobid_listitem_normal, parent, false);
